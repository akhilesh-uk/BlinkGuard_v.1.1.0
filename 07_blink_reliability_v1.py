...
# ============================================================
# BLINKGUARD
# BLINK DETECTION RELIABILITY EXPERIMENT
# (Hysteresis state machine + synchronized ground truth)
# ============================================================
#
...
print()
print("RECORDING STARTED. Press SPACE for each blink. Press Q to stop.")
print()
    ...
    if face_detected:
        ...
        if MIN_VALID_EAR <= average_ear_value <= MAX_VALID_EAR:
            ...
            if smoothed_ear is None:
                smoothed_ear = average_ear_value
            else:
                smoothed_ear = (
                    SMOOTHING_ALPHA * average_ear_value
                    + (1.0 - SMOOTHING_ALPHA) * smoothed_ear
                )
